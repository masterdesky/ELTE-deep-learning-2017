...
def read_train_data():
    i = 0
    with gzip.open('C:/Users/Lordpb/Documents/GitHub/Kaggle-Phys-Photoz/input/train.csv.gz', 'rt', newline='') as csv_file:
...
def write_data(result):
    with open('C:/Users/Lordpb/Documents/GitHub/Kaggle-Phys-Photoz/output/sdss_predict.csv', 'w') as csv_file:
...
def read_test_data():
    i = 0
    with gzip.open('.C:/Users/Lordpb/Documents/GitHub/Kaggle-Phys-Photoz/input/test.csv.gz', 'rt', newline='') as csv_file:
        reader = csv.reader(csv_file)
        row_count = 456227
        X = np.zeros((row_count, 5))
        for row in reader:
